...
| `STALL_LIMIT` | `50000` | If the score (accuracy) doesn't improve, add a new gate. |
| `OPTIMIZATION_PLATEAU_LIMIT` | `100000` | If the *size* of the solution doesn't drop, apply a "Kick" (random mutation). |
| `TERMINATION_PLATEAU` | `4000000` | If the *best* size found hasn't changed for this long, stop and print results. |
